...
if(isset($_POST['submit'] )) 
{
	...
	else
	{
      ...
      $check_email = mysqli_query($db, "SELECT email FROM users where email = '".$_POST['email']."' ");
		...
		$fname = $_FILES['file']['name'];
								...
								$store = "admin/Res_img/custo/".basename($fnew);   
   ...
   {        
	...
	$sql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address,img) VALUES('".$_POST['username']."','".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."','".$fnew."')";
	mysqli_query($db, $sql);
...
<body>
<div style=" background-image: url('images/img/loginBG.jpg');">
