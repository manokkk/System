...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update admin set username='$_POST[uname]', f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',password='".md5($_POST[password])."' where adm_id='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Restaurant</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_hairstyle.php">All Restaurants</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_hairstyle.php">Add Restaurant</a></li>
