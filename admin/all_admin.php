         ...
         <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/siteLogo.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Admin/Staff</h4>
                            </div>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
                                                                                    ...
                                                                                    <td>'.$rows['l_name'].'</td>
																								...
																								<center><img src="Res_img/admin/'.$rows['img'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																								</div></td>
																									 <td><a href="delete_admin.php?adm_del='.$rows['adm_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_admin.php?adm_upd='.$rows['adm_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
																		}	
														}
											?>
